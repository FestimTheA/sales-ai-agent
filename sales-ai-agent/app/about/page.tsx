      ...
      >
        ...
        <div className="flex items-center gap-3 px-3">
          <Avatar
            ...
            className="flex-none"
            size="sm"
            src="https://shorturl.at/dCNjg"
          />
          <div className={cn("flex max-w-full flex-col", {hidden: isCompact})}>
            <p className="truncate text-small font-medium text-default-600">Festim Bejtullahu</p>
            {/* <p className="truncate text-tiny text-default-400">CEO</p> */}
          </div>
        </div>
        {/* <div
