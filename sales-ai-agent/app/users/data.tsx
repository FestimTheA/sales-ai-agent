...
const generateMockUserData = (count: number): Users[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // const selectedRole0 = TimeCreated[Math.floor(Math.random() * TimeCreated.length)];
    // const selectedRole1 = TimeLastUpdated[Math.floor(Math.random() * TimeLastUpdated.length)];
    const selectedRole1 = FirstName[Math.floor(Math.random() * FirstName.length)];
    const selectedRole2 = LastName[Math.floor(Math.random() * LastName.length)];
    const selectedRole30 = email[Math.floor(Math.random() * email.length)];
    const selectedRole40 = role[Math.floor(Math.random() * role.length)];
    ...
    const user: Users = {
      ...
      // TimeCreated: selectedRole0,
      // TimeLastUpdated:selectedRole1,
      FirstName: selectedRole1,
      LastName: selectedRole2,
      Email: selectedRole30,
      Role: selectedRole40,
