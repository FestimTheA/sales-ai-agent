...
// Removed imports for sorting icons
...
export default function DocsPage() {
  ...
  // No sorting, so sortedItems is just items
  ...
  const renderCell = useMemoizedCallback((user: Users, columnKey: React.Key) => {
    ...
    const cellValue = user[userKey as keyof Users] as string;
  ...
  return (
    <div className="h-screen w-screen p-6">
      ...
      <Table
        isHeaderSticky
        aria-label="Example table without sorting"
